...
import { MsgServerStatus } from './admin/MsgServerStatus';
import { ReqAuth, ResAuth } from './admin/PtlAuth';
import { ReqCreateRoom, ResCreateRoom } from './admin/PtlCreateRoom';
...
export interface ServiceType {
    ...
    msg: {
        "admin/ServerStatus": MsgServerStatus,
...
export const serviceProto: ServiceProto<ServiceType> = {
    ...
    "types": {
        "admin/MsgServerStatus/MsgServerStatus": {
            "type": "Interface",
            "properties": [
                {
                    "id": 0,
